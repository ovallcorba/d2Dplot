...
public class PDSearchResult implements Comparable<PDSearchResult> {
    ...
    private final float residual_positions; //es el residual basic per defecte
    private final float residual_intensities;
    ...
    public float getResidualPositions() {
        return this.residual_positions;
    }

    public float getResidual_intensities() {
        return this.residual_intensities;
    }
    ...
    public int compareTo(PDSearchResult arg0) {
        ...
        //        
        //        return 0;
        return Float.compare(this.getTotal_residual(), arg0.getTotal_residual()); //TODO canviat març 2019
    }
    ...
    public String toString() {
        return String.format("%7.3f  %d/%d  %s  [%s] (aka: %s)", this.getTotal_residual(), nDSPin,
                this.getC().getNrRefUpToDspacing(minDSPin), this.getC().getCompName().get(0), this.getC().getFormula(),
                this.getC().getAltNames());
    }
}
