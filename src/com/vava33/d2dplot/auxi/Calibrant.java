...
public class Calibrant {
    ...
    public static float[] LaB6_d = { 4.156878635f, 2.939357609f,
    ...
    public static float[] Silicon_d = { 3.1356938f, 1.9202274f, 1.6375760f, 1.3578002f, 1.2460120f, 1.1086449f, 1.0452367f, 0.9601140f, 0.9180468f, 0.8587511f, 0.8282547f};
